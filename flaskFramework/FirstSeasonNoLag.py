...
def predict():
    try:
        ...
        # Apply first differencing to 'Amount' and 'CU_M'
        df_monthly['Amount_diff'] = df_monthly['Amount'].diff()
        ...
        last_observed_value_amount = df_monthly['Amount'].iloc[-1]
        forecast_amount = forecast_amount_diff_mean.cumsum() + last_observed_value_amount
        ...
        last_observed_value_cum = df_monthly['CU_M'].iloc[-1]
        forecast_cum = forecast_cum_diff_mean.cumsum() + last_observed_value_cum
