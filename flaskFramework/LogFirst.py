...
def predict():
    try:
        ...
        # Apply first differencing to the log-transformed 'Amount' and 'CU_M'
        df_monthly['Amount_log_diff'] = df_monthly['Amount_log'].diff()
        df_monthly['CU_M_log_diff'] = df_monthly['CU_M_log'].diff()

        # Drop NA values generated by differencing
        ...
        # Fit auto_arima model to find the best order for 'Amount_log_diff'
        ...
        # Print the best order found by auto_arima for 'Amount_log_diff'
        ...
        # Fit ARIMA model for 'Amount_log_diff'
        model_amount = ARIMA(
            train['Amount_log_diff'],
        ...
        # Create a forecast for 'Amount_log_diff'
        ...
        # Fit auto_arima model to find the best order for 'CU_M_log_diff'
        ...
        # Create a forecast for 'CU_M_log_diff'
