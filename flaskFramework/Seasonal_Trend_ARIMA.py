...
def predict():
    try:
        ...
        # Apply seasonal and trend differencing to 'Amount' and 'CU_M'
        ...
        df_monthly['Amount_diff'] = df_monthly['Amount_diff'].diff().dropna()
        df_monthly['CU_M_diff'] = df_monthly['CU_M_diff'].diff().dropna()
