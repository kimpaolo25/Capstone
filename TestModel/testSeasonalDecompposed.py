...
def predict():
    try:
        ...
        df_monthly['Seasonality_Amount'] = decomposition_amount.seasonal
        df_monthly['Residuals_Amount'] = decomposition_amount.resid

        df_monthly['Trend_CU_M'] = decomposition_cum.trend
        df_monthly['Seasonality_CU_M'] = decomposition_cum.seasonal
        df_monthly['Residuals_CU_M'] = decomposition_cum.resid
        ...
        # ---- ARIMA for Trend_Amount ----
        model_auto_arima_amount = auto_arima(train['Trend_Amount'].dropna(), seasonal=False, stepwise=True, trace=True)
        ...
        # ---- ARIMA for Trend_CU_M ----
        model_auto_arima_cum = auto_arima(train['Trend_CU_M'].dropna(), seasonal=False, stepwise=True, trace=True)
